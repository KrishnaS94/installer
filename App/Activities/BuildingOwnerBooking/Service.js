...
export default class Service extends Component {
  ...
  <Image
    ...
    style={{width: 30, height: 30, borderRadius: 2 , marginLeft: 310, margin:10,marginTop:-10}}
  />
  
  <View style={styles.lineStyle} />
  <Text style={{paddingRight:40}}>Menu</Text>
  </View>
) 
}
    ...
    render() {
        ...
        <Text style={{marginTop:65,marginLeft: 80}}>Our Services</Text>
